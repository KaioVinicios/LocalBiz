...
| Hugo Gomes | 1. Adicionar cliente <br> 2. Lista de clientes <br> 3. Dados do cliente <br> 4. Cadastro de Produto <br> 5. Edição de Produto <br> 6. Listagem de produtos <br> 7. Estoque do Produto |
