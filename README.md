...
| Nome | Telas | Link Vídeo |
| :--- | :--- | ---: |
| Kaio Vinícios Da Silva Gois | 1. Configurações do negócio <br> 2. Editar perfil do Negócio <br> 3. Configurações de Relatório | https://drive.google.com/file/d/1S7UJlRjnRnfXluK1VFDxqPMhEIUUNjlE/view?usp=sharing |
| Hugo Gomes de Oliveira | 1. Adicionar cliente <br> 2. Lista de clientes <br> 3. Dados do cliente <br> 4. Cadastro de Produto <br> 5. Edição de Produto <br> 6. Listagem de produtos <br> 7. Estoque do Produto | https://www.youtube.com/watch?v=V-nTLJu9s3A
